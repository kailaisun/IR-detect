_base_ = '../third_party/mmdetection/configs/dino/dino-4scale_r50_8xb2-12e_coco.py'
...
model = dict(bbox_head=dict(num_classes=4), test_cfg=dict(max_per_img=100))
...
test_evaluator = dict(
    ...
    classwise=True,
    outfile_prefix='mmdetection_work_dirs/dino_4scale_r50/test_predictions')
...
work_dir = 'mmdetection_work_dirs/dino_4scale_r50'
